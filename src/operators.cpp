...
get_binary_op_function(TokenType op) {
    ...
    case ADDITION_OPERATOR:
        return
            [](const std::shared_ptr<Object> &l,
               const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> { return l->add(r); };
    case SUBTRACTION_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return l->subtract(r);
        };
    ...
    case LOGICAL_AND_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return l->logical_and(r);
        };
    case LOGICAL_OR_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return l->logical_or(r);
        };
    ...
    case LESS_THAN_EQUAL_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return l->less_than_equal(r);
        };
    case GREATER_THAN_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return r->less_than(l);
        };
    case GREATER_THAN_EQUAL_OPERATOR:
        return [](const std::shared_ptr<Object> &l,
                  const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> {
            return r->less_than_equal(l);
        };
    case EQUAL_OPERATOR:
        return
            [](const std::shared_ptr<Object> &l,
               const std::shared_ptr<Object> &r) -> std::shared_ptr<Object> { return l->equal(r); };
...
get_unary_op_function(TokenType op) {
    switch (op) {
    case ADDITION_OPERATOR:
        return [](const std::shared_ptr<Object> &o) -> std::shared_ptr<Object> {
            return o->positive();
        };
    case SUBTRACTION_OPERATOR:
        return [](const std::shared_ptr<Object> &o) -> std::shared_ptr<Object> {
