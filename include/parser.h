...
private:
    ...
    static ASTNode *parse_primary_expression(), *parse_assignment_expression(), *parse_logical_or_expression(),
            *parse_logical_and_expression(), *parse_bitwise_or_expression(), *parse_bitwise_xor_expression(),
            *parse_bitwise_and_expression(), *parse_equality_expression(), *parse_relational_expression(),
            *parse_range_literal_expression(), *parse_additive_expression(), *parse_multiplicative_expression(),
            *parse_unary_expression(), *parse_factor_expression();
};
